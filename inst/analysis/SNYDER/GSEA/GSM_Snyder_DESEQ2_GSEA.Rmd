...
---
This markdown performs GSMGSEA on the result of the preceding differential expression analysis (DeSeq2) of Snyder data set. The results are saved as an .rds file, which is then used for the subsequent visualization step.
...
for(Y in list(list("Snyder_All" = Snyder_DESEQ_matrix),
  ...
  for(i in list_of_gmt_files){
    print(i)
    res <- GSMGSEA(gene_list = snyder_gene_list, theGoFile = i, pval = 0.05)
