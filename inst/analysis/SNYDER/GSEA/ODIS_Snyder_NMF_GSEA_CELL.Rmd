...
nmf_norm_cell <- normalize(Snyder_NMF_CELL, method = "range", range = c(0, 1), margin = 1L, on.constant = "quiet")
head(nmf_norm_cell)
df1 <- nmf_norm_cell[,1]
head(df1)
...
head(snyder_nmfs_cell$V2$`./myC1.gmt`$Results)
str(snyder_nmfs_cell$V2$orig_matrix$log2FoldChange)

saveRDS(snyder_nmfs_cell, "./Snyder_NMF_CELL_V123.rds")
