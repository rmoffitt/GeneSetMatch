...
my_entrez_readcounts <- snyder_readcounts[,c(2:29, 33)]
my_entrez_readcounts$ENTREZ <- as.character(my_entrez_readcounts$ENTREZ)
...
for(i in list_of_gmt_files){
  print(i)
  res <- ODIS::ODISGSEA(gene_list = gene_list, theGoFile = i, pval = 0.95) ## need to structure outputs correctly
}
