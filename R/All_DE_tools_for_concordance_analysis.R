...
meanEx_Poisson <- function(norm.count.dat,conditions)
{
  conditions <- as.factor(conditions)
  Adata <- norm.count.dat[,conditions==levels(conditions)[1]]
  Bdata <- norm.count.dat[,conditions==levels(conditions)[2]]
