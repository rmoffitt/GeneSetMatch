...
MouseENS2MouseENT <- function(MouseGenes){
  mouseENT = useMart("ensembl", dataset = "mmusculus_gene_ensembl", host = "https://www.ensembl.org") #useast.ensembl.org is down
  mouseENS = useMart("ensembl", dataset = "mmusculus_gene_ensembl", host = "https://www.ensembl.org") #useast.ensembl.org is down
