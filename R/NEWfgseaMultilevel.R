...
NEWfgseaMultilevel <- function(pathways,
                            stats,
                            sampleSize  = 101,
                            minSize     = 1,
                            maxSize     = Inf,
                            ...
                            absEps      = NULL)
{
  ...
  print("printing scoreType")
  print(scoreType)
  
  pp <- NEWpreparePathwaysAndStats(pathways, stats, minSize, maxSize, gseaParam, scoreType)
  print("str pp")
  print(str(pp))
  print("head pp$filtered")
  print(head(pp$filtered))
